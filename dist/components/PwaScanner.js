...
export default function PwaScanner({ serverUrl: initialUrl, renderResult, onResult, ...rest }) {
    ...
    if (!configured || tab === 'config') {
        return (_jsx("div", { style: { minHeight: '100vh', backgroundColor: '#0f172a', color: '#e2e8f0', padding: 20 }, children: _jsxs("div", { style: { maxWidth: 400, margin: '0 auto' }, children: [_jsxs("div", { style: { textAlign: 'center', marginBottom: 24 }, children: [_jsx("div", { style: { fontSize: 48 }, children: "\uD83D\uDCF7" }), _jsx("h1", { style: { fontSize: 22, fontWeight: 700 }, children: config.appName }), _jsx("p", { style: { color: '#94a3b8', fontSize: 14 }, children: "Configuration du scanner" })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 16 }, children: [_jsxs("div", { children: [_jsx("label", { style: { fontSize: 13, color: '#94a3b8', display: 'block', marginBottom: 4 }, children: "URL du serveur" }), _jsx("input", { value: config.serverUrl, onChange: e => setConfig({ ...config, serverUrl: e.target.value }), placeholder: "http://localhost:4488", style: inputStyle })] }), _jsxs("div", { children: [_jsx("label", { style: { fontSize: 13, color: '#94a3b8', display: 'block', marginBottom: 4 }, children: "Collection" }), _jsx("input", { value: config.collection, onChange: e => setConfig({ ...config, collection: e.target.value }), placeholder: "reservations", style: inputStyle })] }), _jsxs("div", { children: [_jsx("label", { style: { fontSize: 13, color: '#94a3b8', display: 'block', marginBottom: 4 }, children: "Champ QR code" }), _jsx("input", { value: config.codeField, onChange: e => setConfig({ ...config, codeField: e.target.value }), placeholder: "qrCode", style: inputStyle })] }), _jsxs("div", { children: [_jsx("label", { style: { fontSize: 13, color: '#94a3b8', display: 'block', marginBottom: 4 }, children: "Token (optionnel)" }), _jsx("input", { value: config.token || '', onChange: e => setConfig({ ...config, token: e.target.value }), placeholder: "Bearer token", type: "password", style: inputStyle })] })] }), _jsx("button", { onClick: handleTestConnection, disabled: testing || !config.serverUrl, style: { width: '100%', padding: 12, backgroundColor: '#3b82f6', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer', marginBottom: 8 }, children: testing ? '⏳ Test...' : '🔌 Tester la connexion' }), testResult && (_jsx("div", { style: { padding: 10, borderRadius: 8, marginBottom: 8, fontSize: 13,
                            backgroundColor: testResult.ok ? '#064e3b' : '#7f1d1d', color: testResult.ok ? '#6ee7b7' : '#fca5a5' }, children: testResult.ok ? `✅ Connecté — ${testResult.entities?.length || 0} entités` : `❌ ${testResult.error}` })), _jsx("button", { onClick: saveConfig, disabled: !config.serverUrl, style: { width: '100%', padding: 12, backgroundColor: '#22c55e', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' }, children: "\u2713 Sauvegarder" })] }) }));
    }
    // ── Main Scanner ───────────────────────────────────
